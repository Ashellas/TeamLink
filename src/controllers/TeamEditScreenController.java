 ...
 */
public class TeamEditScreenController implements InitializeData {
    ...
    public void initData(UserSession userSession) {
        ...
        ageGroupBox.setDisable(true);
    }

    public void getInformation(Team team) {
        teamNameField.setText(team.getTeamName());
        abbrevationField.setText(team.getAbbrevation());
        ageGroupBox.setValue(team.getAgeGroup());
        cityBox.setValue(team.getCity());
        if (team.getTeamLogo() == null) {
            teamLogoView.setImage((new Image("/Resources/Images/emptyTeamLogo.png")));
            uploadImageButton.setText("Upload Image");
        }
        else {
            teamLogoView.setImage(team.getTeamLogo().getImage());
